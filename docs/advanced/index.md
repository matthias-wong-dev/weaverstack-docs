...
Use Advanced when the ordinary lifecycle is understood but a mechanism changes how you plan, execute or recover work.
...
| What changes between desktop, Fabric-hosted and unattended execution? | [Automation and execution contexts](automation-and-execution-contexts.md) |

Use [Basics](../basics/index.md) for normal authoring and estate operation. Use [Reference](../reference/index.md) for exact syntax, metadata, result representations and operation behaviour.
