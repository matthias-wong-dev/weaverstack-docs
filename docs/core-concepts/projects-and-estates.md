...
The [Project contract](../reference/weaver-documents/overview.md) defines the source boundary and discovery rules. Next, [Logical and physical items](logical-and-physical-items.md) explains how stable project identities are bound to Fabric.
