...
Do not subclass `SparkSqlTest` in repository Python. Author the SQL validation file described in [Validate an installed estate](../../guides/validation.md); Build generates this class.
