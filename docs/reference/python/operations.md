...
The operation model and state transitions are in [Weaver operations](../../core-concepts/weaver-operations.md). For command output, interaction policy and exit status, use the [CLI reference](../cli.md).
