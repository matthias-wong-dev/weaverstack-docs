...
See [Configure workspaces and Fabric Environments](../guides/environments.md) for an end-to-end setup and the [CLI reference](../reference/cli.md) for command options.
